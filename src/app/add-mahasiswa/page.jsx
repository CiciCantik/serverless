            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-white p-8 rounded-lg shadow-lg">
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        className="w-full px-4 py-3 rounded-md border border-gray-200 focus:border-blue-600 focus:ring-2 focus:ring-blue-200 transition duration-200 text-gray-700"
                        required
                ...
                <div className="space-y-2">
                    ...
                    {foto && (
                        <p className="mt-2 text-sm text-green-600 font-medium flex items-center">
                            <svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://w3.org/2000/svg">
